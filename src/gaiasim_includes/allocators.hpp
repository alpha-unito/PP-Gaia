...
//         hipMallocManaged((void**)&ptr,sizeof(T)*tmp);
//     #elif __HIPCC__
//         hipHostMalloc((void**)&ptr,sizeof(T)*tmp,hipHostMallocDefault);
//     #else
//         ptr = new T[tmp];
//     #endif
// }
...
inline void fast_allocate_vector(T* &ptr, const I& elements) {
    long tmp = elements == 0 ? 1 : elements;
        ...
        // hipHostMalloc((void**)&ptr,sizeof(T)*tmp,hipHostMallocNonCoherent);
    #else
        ptr = new T[tmp]();
    #endif
}
