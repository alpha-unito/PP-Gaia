...
int main(int argc, char **argv)
{
    ...
    if (constr_params::extConstraint)
        system_params::nElements += constr_params::nEqExtConstr;
    if (constr_params::barConstraint)
        system_params::nElements += constr_params::nEqBarConstr;
    if (astro_params::nOfInstrConstr > 0)
        system_params::nElements += astro_params::nOfInstrConstr;
...
#ifdef USE_MPI
    if (astro_params::nAstroPSolved)
        SumCirc(lsqr_arrs::preCondVect, comlsqr);
#endif
